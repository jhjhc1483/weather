...
(function () {
  ...
  const ALERT_CRITERIA = {
    ...
    'PM10': {
      '주의보': '기상조건 등을 고려하여 PM10 1시간 평균농도가 150㎍/㎥ 이상 2시간 이상 지속될 때',
      '경보': '기상조건 등을 고려하여 PM10 1시간 평균농도가 300㎍/㎥ 이상 2시간 이상 지속될 때'
    },
    'PM2.5': {
      '주의보': '기상조건 등을 고려하여 PM2.5 1시간 평균농도가 75㎍/㎥ 이상 2시간 이상 지속될 때',
      '경보': '기상조건 등을 고려하여 PM2.5 1시간 평균농도가 150㎍/㎥ 이상 2시간 이상 지속될 때'
    }
  };
